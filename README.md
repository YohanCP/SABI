...
Aplikasi Smart Bus ITERA adalah solusi aplikasi mobile untuk tracking bus yang dibangun dengan Framework modern untuk menjamin performa cepat dan *user experience* yang intuitif.
...
| **Database** | PostgreSQL | Database utama untuk penyimpanan data persisten. |
